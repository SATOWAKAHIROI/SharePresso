-- CreateEnum
CREATE TYPE "RepostType" AS ENUM ('REPOST', 'QUOTE');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('LIKE', 'REPOST', 'QUOTE', 'FOLLOW');
...
-- CreateIndex
CREATE UNIQUE INDEX "Repost_userId_postId_type_key" ON "Repost"("userId", "postId", "type");
